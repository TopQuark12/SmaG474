...
#define ARR_DESC_INTERNAL_DEFINE(name, data_ptr, element_count, element_size) \
    ARR_DESC_t name = {                                                       \
        data_ptr, element_count, element_size, element_count * element_size}
...
#define ARR_DESC_DEFINE_SUBSET(name, original, element_cnt) \
    ARR_DESC_INTERNAL_DEFINE(                               \
        ...
        element_cnt,                                        \
        sizeof(                                             \
            ARR_DESC_ARR_NAME(original)[0])) /* Note the lacking semicolon */
 ...
 *  is left to the user.
 */
#define ARR_DESC_DEFINE_USING_ARR(                            \
    type, name, array_ptr, start_idx, element_cnt)            \
    ARR_DESC_INTERNAL_DEFINE(name,                            \
