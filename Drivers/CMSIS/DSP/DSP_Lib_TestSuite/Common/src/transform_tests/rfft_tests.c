...
*/
#define RFFT_DEFINE_TEST(                                              \
    suffix, config_suffix, ifft_flag, input_type, output_type)         \
    ...
    {                                                                  \
        ...
        TEMPLATE_DO_ARR_DESC(                                          \
            ...
            arm_rfft_init_##suffix(                                    \
                &rfft_inst_fut, (uint32_t)fftlen, ifft_flag, 1U);      \
                                                                       \
            arm_rfft_init_##suffix(                                    \
                &rfft_inst_ref, (uint32_t)fftlen, ifft_flag, 1U);      \
                                                                       \
            if (ifft_flag) {                                           \
            ...
            JTEST_COUNT_CYCLES(                                        \
                arm_rfft_##suffix(&rfft_inst_fut,                      \
...
RFFT_DEFINE_TEST(
    q31, forward, 0U, TYPE_FROM_ABBREV(q31), TYPE_FROM_ABBREV(q31));
RFFT_DEFINE_TEST(
    q15, forward, 0U, TYPE_FROM_ABBREV(q15), TYPE_FROM_ABBREV(q15));
// RFFT_DEFINE_TEST(f32, inverse, 1U, TYPE_FROM_ABBREV(f32),
// TYPE_FROM_ABBREV(f32));
RFFT_DEFINE_TEST(
    q31, inverse, 1U, TYPE_FROM_ABBREV(q31), TYPE_FROM_ABBREV(q31));
RFFT_DEFINE_TEST(
    q15, inverse, 1U, TYPE_FROM_ABBREV(q15), TYPE_FROM_ABBREV(q15));
