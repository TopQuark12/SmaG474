            ...
            TEMPLATE_DO_ARR_DESC(                                              \
                ...
                ref_fir_##suffix(&fir_inst,                                    \
                                 ...
                                 blockSize);                                   \
                                                                               \
                for (i = 0; i < numTaps; i++) {                                \
                    *((output_type *)filtering_coeffs_lms + i) =               \
                        (output_type)0;                                        \
                }                                                              \
                                                                               \
                for (i = 0; i < blockSize; i++) {                              \
                    ...
                    *((output_type *)filtering_output_f32_fut + i) =           \
                        *((output_type *)filtering_##suffix##_inputs + i) /    \
                        200.0f;                                                \
                }                                                              \
                                                                               \
            ...
            TEMPLATE_DO_ARR_DESC(                                            \
                ...
                TEMPLATE_DO_ARR_DESC(                                        \
                    ...
                    for (i = 0; i < blockSize; i++) {                        \
                        ...
                        *((output_type *)filtering_output_f32_fut + i) =     \
                            *((output_type *)filtering_##suffix##_inputs +   \
                              i) >>                                          \
                            6;                                               \
                    }                                                        \
                                                                             \
                    ...
                    JTEST_COUNT_CYCLES(arm_lms##config_suffix##_##suffix(    \
                        ...
                        (void *)filtering_input_lms,                         \
                        (void *)filtering_output_fut,                        \
                        (void *)((output_type *)filtering_output_fut +       \
                                 blockSize),                                 \
                        blockSize));                                         \
                                                                             \
                    for (i = 0; i < numTaps; i++) {                          \
                    ...
                    ref_lms##config_suffix##_##suffix(                       \
                        ...
                        (void *)filtering_input_lms,                         \
                        (void *)filtering_output_ref,                        \
                        (void *)((output_type *)filtering_output_ref +       \
                                 blockSize),                                 \
                        blockSize);                                          \
                                                                             \
