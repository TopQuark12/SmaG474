...
#define CONV_TEST_VALID_PARTIAL_PARAMS(                                   \
    input_a_len, input_b_len, first_index, num_points)                    \
...
#define CONV_arm_conv_INPUT_INTERFACE(          \
...
#define CONV_TEST_TEMPLATE(                                                  \
    ...
    {                                                                        \
        TEMPLATE_DO_ARR_DESC(                                                \
            ...
            void *input_b_ptr =                                              \
                ARR_DESC_ELT(                                                \
                    ARR_DESC_t *, input_idx, &(conv_##suffix##_b_inputs))    \
                    ->data_ptr;                                              \
                                                                             \
            TEMPLATE_DO_ARR_DESC(                                            \
                conv_len_idx,                                                \
            ...
            TEMPLATE_DO_ARR_DESC(                                             \
                ...
                TEMPLATE_DO_ARR_DESC(                                         \
                    ...
                    TEMPLATE_DO_ARR_DESC(                                     \
                        ...
                        num_points,                                           \
                        num_points_arr_desc,                                  \
                        if (CONV_TEST_VALID_PARTIAL_PARAMS(conv_len_a,        \
                                                           conv_len_b,        \
                                                           first_index,       \
                                                           num_points)) {     \
