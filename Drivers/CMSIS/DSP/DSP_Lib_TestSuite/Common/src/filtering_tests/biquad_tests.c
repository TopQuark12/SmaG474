...
#define BIQUAD_WITH_POSTSHIFT_DEFINE_TEST(                                     \
    suffix, config_suffix, speed, output_type)                                 \
    JTEST_DEFINE_TEST(                                                         \
            ...
            TEMPLATE_DO_ARR_DESC(                                              \
                ...
                TEMPLATE_DO_ARR_DESC(                                          \
                    ...
                    ref_biquad_cascade_##config_suffix##speed##_##suffix(      \
                        ...
                        blockSize);                                            \
                                                                               \
                    FILTERING_SNR_COMPARE_INTERFACE(blockSize,                 \
                                                    output_type))));           \
                                                                               \
        return JTEST_TEST_PASSED;                                              \
    }
    ...
    TEMPLATE_DO_ARR_DESC(
        ...
        TEMPLATE_DO_ARR_DESC(
            ...
            TEMPLATE_DO_ARR_DESC(
                ...
                JTEST_COUNT_CYCLES(
                    arm_biquad_cas_df1_32x64_q31(&biquad_inst_fut,
...
JTEST_DEFINE_TEST(arm_biquad_cascade_df2T_f64_test, arm_biquad_cascade_df2T_f64)
{
    ...
    TEMPLATE_DO_ARR_DESC(
        ...
        TEMPLATE_DO_ARR_DESC(
            ...
            JTEST_COUNT_CYCLES(
                arm_biquad_cascade_df2T_f64(&biquad_inst_fut,
