...
#define MATRIX_TEST_VALID_ADDITIVE_DIMENSIONS(  \
    input_type, matrix_a_ptr, matrix_b_ptr)     \
...
#define MATRIX_TEST_VALID_MULTIPLICATIVE_DIMENSIONS( \
    input_type, matrix_a_ptr, matrix_b_ptr)          \
    (((input_type)(matrix_a_ptr))->numCols ==        \
     ((input_type)(matrix_b_ptr))->numRows)
...
#define MATRIX_TEST_CONFIG_ADDITIVE_OUTPUT(         \
    input_type, matrix_a_ptr, matrix_b_ptr)         \
    do                                              \
    {                                               \
...
#define MATRIX_TEST_CONFIG_MULTIPLICATIVE_OUTPUT(   \
    input_type, matrix_a_ptr, matrix_b_ptr)         \
    do                                              \
    {                                               \
        ((input_type)&matrix_output_fut)->numRows = \
