...
#define TEST_CONVERT_AND_ASSERT_SNR(ref_dst_ptr,                          \
    ...
    {                                                                     \
        TEST_CONVERT_TO_FLOAT(                                            \
            ref_src_ptr, ref_dst_ptr, block_size, tst_src_type);          \
        TEST_CONVERT_TO_FLOAT(                                            \
            tst_src_ptr, tst_dst_ptr, block_size, tst_src_type);          \
 ...
 *  8 * 32 = 256 > 64.
 */
#define TEST_DO_VALID_BLOCKSIZE(                                      \
    block_size, fn_type_spec, input_arr_desc, body)                   \
    do                                                                \
    {                                                                 \
    ...
    {                                                                  \
        ...
        TEMPLATE_DO_ARR_DESC(                                          \
            ...
            TEMPLATE_DO_ARR_DESC(                                      \
                ...
                void *input_b_ptr =                                    \
                    ARR_DESC_ELT(                                      \
                        ARR_DESC_t *, input_idx, &(arr_desc_inputs_b)) \
                        ->data_ptr;                                    \
                                                                       \
                TEST_DO_VALID_BLOCKSIZE(                               \
                    block_size,                                        \
            ...
            TEST_CALL_FUT_AND_REF(                                                                               \
                ...
                ref_arg_interface(                                                                               \
                    ...
                    elt_b)); /* Comparison interfaces typically accept */ /* a                                   \
                                                                             block_size. Pass a dummy value 1.*/ \
            compare_interface(1, output_type));                                                                  \
        return JTEST_TEST_PASSED;                                                                                \
    } while (0)
