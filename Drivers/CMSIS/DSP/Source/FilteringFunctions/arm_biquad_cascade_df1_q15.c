                                ...
                                uint32_t blockSize)
{
    ...
    do
    {
        ...
        /* First part of the processing with loop unrolling.  Compute 2 outputs
         *at a time.
        ...
        while (sample > 0U)
        {
            ...
            /* The result is converted from 3.29 to 1.31 if postShift = 1, and
             ...
             */
            /* y[n-N], y[n-N-1] are packed together to make state_out of type
             * q31 */
