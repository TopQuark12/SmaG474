                                         ...
                                         q15_t *pScratch2)
{
    ...
    else
    {
        ...
        /* First part of the processing with loop unrolling copies 4 data points
         *at a time.
         ** a second loop below copies for the remaining 1 to 3 samples. */

        /* Copy smaller length input sequence in reverse order into second
         * scratch buffer */
        while (k > 0U)
        {
        ...
        /* First part of the processing with loop unrolling process 4 data
         *points at a time.
        ...
        while (blkCnt > 0)
        {
            ...
            /* Update scratch pointer for remaining samples of smaller length
             * sequence */
            pScr1 -= 4U;
