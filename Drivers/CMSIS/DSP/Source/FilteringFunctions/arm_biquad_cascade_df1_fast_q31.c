                                     ...
                                     uint32_t blockSize)
{
    ...
    do
    {
        ...
        /* First part of the processing with loop unrolling.  Compute 4 outputs
         *at a time.
        ...
        while (sample > 0U)
        {
            ...
            /* acc +=  b1 * x[n-1] */
            /*acc = (q31_t) ((((q63_t) acc << 32) + ((q63_t) b0 * (Xn))) >>
             * 32);*/
            multAcc_32x32_keep32_R(acc, b0, Xn);
            /* acc +=  b[2] * x[n-2] */
            /*acc = (q31_t) ((((q63_t) acc << 32) + ((q63_t) b2 * (Xn2))) >>
             * 32);*/
            multAcc_32x32_keep32_R(acc, b2, Xn2);
            /* acc +=  a1 * y[n-1] */
            /*acc = (q31_t) ((((q63_t) acc << 32) + ((q63_t) a1 * (Yn1))) >>
             * 32);*/
            multAcc_32x32_keep32_R(acc, a1, Yn1);
            /* acc +=  a2 * y[n-2] */
            /*acc = (q31_t) ((((q63_t) acc << 32) + ((q63_t) a2 * (Yn2))) >>
             * 32);*/
            ...
            *pOut = Yn2;
            ...
            /* acc +=  b1 * x[n-1] */
            /*acc = (q31_t) ((((q63_t) acc << 32) + ((q63_t) b1 * (Xn))) >>
             * 32);*/
            multAcc_32x32_keep32_R(acc, b1, Xn);
            /* acc +=  b[2] * x[n-2] */
            /*acc = (q31_t) ((((q63_t) acc << 32) + ((q63_t) b2 * (Xn1))) >>
             * 32);*/
            multAcc_32x32_keep32_R(acc, b2, Xn1);
            /* acc +=  a1 * y[n-1] */
            /*acc = (q31_t) ((((q63_t) acc << 32) + ((q63_t) a1 * (Yn2))) >>
             * 32);*/
            multAcc_32x32_keep32_R(acc, a1, Yn2);
            /* acc +=  a2 * y[n-2] */
            /*acc = (q31_t) ((((q63_t) acc << 32) + ((q63_t) a2 * (Yn1))) >>
             * 32);*/
            ...
            *(pOut + 1U) = Yn1;
            ...
            /* acc +=  b1 * x[n-1] */
            /*acc = (q31_t) ((((q63_t) acc << 32) + ((q63_t) b1 * (Xn2))) >>
             * 32);*/
            multAcc_32x32_keep32_R(acc, b1, Xn2);
            /* acc +=  b[2] * x[n-2] */
            /*acc = (q31_t) ((((q63_t) acc << 32) + ((q63_t) b2 * (Xn))) >>
             * 32);*/
            ...
            *(pOut + 2U) = Yn2;
            ...
            /* acc +=  b1 * x[n-1] */
            /*acc = (q31_t) ((((q63_t) acc << 32) + ((q63_t) b1 * (Xn1))) >>
             * 32);*/
