                  ...
                  q15_t *pInlineBuffer)
{
     ...
     * Hence changing the format of N (i.e. 2*N elements) complex numbers
     * to 1.15 format by shifting left by 2 bits. */
    ...
    *pbuff++ = in;
    ...
    do
    {
         ...
         * Y4(k-1) */
        /* pState pointer (pS1) is incremented twice as the real values are
         * located alternatively in the array */
        in = *pS1++ - in;
        *pbuff++ = in;
