                             ...
                             arm_matrix_instance_q15 *pDst)
{
...
#endif  //    #ifdef ARM_MATH_MATRIX_CHECK
    {
        ...
        {
            /* C(m,n) = A(m,n) * k */
            /* Scale, saturate and then store the results in the destination
             * buffer. */
            ...
            /* C = A * scale */
            /* Scale the inputs and then store the 2 results in the destination
             * buffer in single cycle by packing the outputs */
        ...
        /* If the numSamples is not a multiple of 4, compute any remaining
         *output samples here.
