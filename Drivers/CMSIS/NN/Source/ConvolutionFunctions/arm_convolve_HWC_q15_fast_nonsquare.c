        ...
        for (i_out_x = 0; i_out_x < dim_im_out_x; i_out_x++)
        {
                 ...
                 i_ker_y++)
            {
                     ...
                     i_ker_x++)
                {
                    ...
                    {
                        /* arm_copy_q15((q15_t *) Im_in + (i_ker_y * dim_im_in_x
                         * + i_ker_x) * ch_im_in, pBuffer, ch_im_in); */
                        memcpy(pBuffer,
                               (q15_t *)Im_in +
            ...
            if (i_out_x & 0x1)
            {
                ...
                for (i = 0; i < ch_im_out; i += 2)
                {
                    ...
                    q15_t *pB = im_buffer;
                    const q15_t *pB2 =
                        pB + ch_im_in * dim_kernel_y * dim_kernel_x;
                    ...
                    uint16_t colCnt =
                        ch_im_in * dim_kernel_y * dim_kernel_x >> 1;
