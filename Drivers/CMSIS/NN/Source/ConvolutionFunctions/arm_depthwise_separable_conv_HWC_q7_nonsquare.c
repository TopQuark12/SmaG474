    ...
    q7_t *bufferB)
{
     ...
     * accumulator Mid   loop: loop over different output channel Outer loop:
     * loop over different output (x, y)
     *
     */
        ...
        for (i_out_x = 0; i_out_x < dim_im_out_x; i_out_x++)
        {
                 ...
                 i_ker_y++)
            {
                     ...
                     i_ker_x++)
                {
                    ...
                    {
                        /* arm_copy_q7((q7_t *) Im_in + (i_ker_y * dim_im_in_x +
            ...
            {
                q31_t sum =
                    ((q31_t)(*pBias++) << bias_shift) + NN_ROUND(out_shift);
                q31_t sum2 =
                    ((q31_t)(*pBias++) << bias_shift) + NN_ROUND(out_shift);
                q31_t sum3 =
                    ((q31_t)(*pBias++) << bias_shift) + NN_ROUND(out_shift);
