...
extern "C"
{
     ...
     *
     * This function is the version with full list of optimization tricks, but
     * with some contraints: ch_im_in is multiple of 4 ch_im_out is multiple of
     * 2
     */
     ...
     *
     * This function is the version with full list of optimization tricks, but
     * with some contraints: ch_im_in is multiple of 2 ch_im_out is multiple of
     * 2
     */
    ...
    /**
     * @brief Matrix-multiplication function for convolution with reordered
     * columns
     * @param[in]       pA          pointer to operand A
     * @param[in]       pInBuffer   pointer to operand B, always conssists of 2
     * vectors
