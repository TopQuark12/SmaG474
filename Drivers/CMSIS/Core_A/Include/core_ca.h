...
#define __IM                                                        \
    volatile const /*!< \brief Defines 'read only' structure member \
                      permissions */
#define __OM \
...
#define RESERVED(N, T) \
    ...
    typedef union
    {
        struct
        {
            ...
            uint32_t
                T : 1; /*!< \brief bit:      5  Thumb execution state bit */
            uint32_t F : 1; /*!< \brief bit:      6  FIQ mask bit */
            uint32_t I : 1; /*!< \brief bit:      7  IRQ mask bit */
            uint32_t
                A : 1; /*!< \brief bit:      8  Asynchronous abort mask bit */
            uint32_t E : 1; /*!< \brief bit:      9  Endianness execution state
                               bit */
            uint32_t IT1 : 6; /*!< \brief bit: 10..15  If-Then execution state
                                 bits 2-7 */
            uint32_t
                GE : 4; /*!< \brief bit: 16..19  Greater than or Equal flags */
            RESERVED(0 : 4, uint32_t)
            uint32_t J : 1;   /*!< \brief bit:     24  Jazelle bit */
            uint32_t IT0 : 2; /*!< \brief bit: 25..26  If-Then execution state
                                 bits 0-1 */
            uint32_t
                Q : 1; /*!< \brief bit:     27  Saturation condition flag */
            uint32_t
                V : 1; /*!< \brief bit:     28  Overflow condition code flag */
            uint32_t
                C : 1; /*!< \brief bit:     29  Carry condition code flag */
            uint32_t Z : 1; /*!< \brief bit:     30  Zero condition code flag */
            uint32_t
                N : 1; /*!< \brief bit:     31  Negative condition code flag */
...
#define CPSR_M_SYS 0x1FU /*!< \brief CPSR: M System mode (PL1) */
    ...
    typedef union
    {
        struct
        {
            ...
            uint32_t
                HA : 1; /*!< \brief bit:    17  Hardware Access flag enable */
            RESERVED(4 : 1, uint32_t)
            uint32_t
                WXN : 1; /*!< \brief bit:    19  Write permission implies XN */
            uint32_t UWXN : 1; /*!< \brief bit:    20  Unprivileged write
                                  permission implies PL1 XN */
            uint32_t FI : 1;   /*!< \brief bit:    21  Fast interrupts
            ...
            uint32_t NMFI : 1; /*!< \brief bit:    27  Non-maskable FIQ (NMFI)
                                  support */
...
#define SCTLR_M_Msk (1UL << SCTLR_M_Pos) /*!< \brief SCTLR: M Mask */
    ...
    typedef union
    {
        ...
        struct
        {
            uint32_t FW : 1; /*!< \brief bit:      0  Cache and TLB maintenance
                                broadcast */
            RESERVED(0 : 5, uint32_t)
            uint32_t SMP : 1;  /*!< \brief bit:     6  Enables coherent requests
                                  to the processor */
            uint32_t EXCL : 1; /*!< \brief bit:     7  Exclusive L1/L2 cache
                                  control */
            RESERVED(1 : 2, uint32_t)
            uint32_t DODMBS : 1; /*!< \brief bit:    10  Disable optimized data
                                    memory barrier behavior */
            uint32_t DWBST : 1; /*!< \brief bit:    11  AXI data write bursts to
                                   Normal memory */
            uint32_t RADIS : 1; /*!< \brief bit:    12  L1 Data Cache
                                   read-allocate mode disable */
            uint32_t
                L1PCTL : 2;  /*!< \brief bit:13..14  L1 Data prefetch control */
            uint32_t BP : 2; /*!< \brief bit:16..15  Branch prediction policy */
            uint32_t RSDIS : 1; /*!< \brief bit:    17  Disable return stack
                                   operation */
            uint32_t BTDIS : 1; /*!< \brief bit:    18  Disable indirect Branch
                                   Target Address Cache (BTAC) */
            RESERVED(3 : 9, uint32_t)
            uint32_t
                DBDI : 1; /*!< \brief bit:    28  Disable branch dual issue */
        ...
        struct
        {
            ...
            uint32_t DODMBS : 1;  /*!< \brief bit:    10  Disable optimized data
                                     memory barrier behavior */
            uint32_t L2RADIS : 1; /*!< \brief bit:    11  L2 Data Cache
                                     read-allocate mode disable */
            uint32_t L1RADIS : 1; /*!< \brief bit:    12  L1 Data Cache
                                     read-allocate mode disable */
            uint32_t
                L1PCTL : 2; /*!< \brief bit:13..14  L1 Data prefetch control */
            uint32_t DDVM : 1; /*!< \brief bit:    15  Disable Distributed
                                  Virtual Memory (DVM) transactions */
        ...
        struct
        {
            ...
            uint32_t WFLZM : 1; /*!< \brief bit:     3  Cache and TLB
            ...
            uint32_t EXCL : 1; /*!< \brief bit:     7  Exclusive L1/L2 cache
                                  control */
            uint32_t AOW : 1;  /*!< \brief bit:     8  Enable allocation in one
                                  cache way only */
            uint32_t PARITY : 1; /*!< \brief bit:     9  Support for parity
...
#define ACTLR_FW_Msk (1UL << ACTLR_FW_Pos) /*!< \brief ACTLR: FW Mask */
    ...
    typedef union
    {
        struct
        {
            uint32_t CP0 : 2;    /*!< \brief bit:  0..1  Access rights for
                                    coprocessor 0 */
            uint32_t CP1 : 2;    /*!< \brief bit:  2..3  Access rights for
                                    coprocessor 1 */
            uint32_t CP2 : 2;    /*!< \brief bit:  4..5  Access rights for
                                    coprocessor 2 */
            uint32_t CP3 : 2;    /*!< \brief bit:  6..7  Access rights for
                                    coprocessor 3 */
            uint32_t CP4 : 2;    /*!< \brief bit:  8..9  Access rights for
                                    coprocessor 4 */
            uint32_t CP5 : 2;    /*!< \brief bit:10..11  Access rights for
                                    coprocessor 5 */
            uint32_t CP6 : 2;    /*!< \brief bit:12..13  Access rights for
                                    coprocessor 6 */
            uint32_t CP7 : 2;    /*!< \brief bit:14..15  Access rights for
                                    coprocessor 7 */
            uint32_t CP8 : 2;    /*!< \brief bit:16..17  Access rights for
                                    coprocessor 8 */
            uint32_t CP9 : 2;    /*!< \brief bit:18..19  Access rights for
                                    coprocessor 9 */
            uint32_t CP10 : 2;   /*!< \brief bit:20..21  Access rights for
                                    coprocessor 10 */
            uint32_t CP11 : 2;   /*!< \brief bit:22..23  Access rights for
                                    coprocessor 11 */
            uint32_t CP12 : 2;   /*!< \brief bit:24..25  Access rights for
                                    coprocessor 11 */
            uint32_t CP13 : 2;   /*!< \brief bit:26..27  Access rights for
                                    coprocessor 11 */
            uint32_t TRCDIS : 1; /*!< \brief bit:    28  Disable CP14 access to
                                    trace registers */
            RESERVED(0 : 1, uint32_t)
            uint32_t
                D32DIS : 1; /*!< \brief bit:    30  Disable use of registers
...
#define CPACR_CP_FA 3U /*!< \brief CPACR CPn field: Full access. */
    ...
    typedef union
    {
        ...
        {
            uint32_t
                FS0 : 4; /*!< \brief bit: 0.. 3  Fault Status bits bit 0-3 */
            uint32_t
                Domain : 4; /*!< \brief bit: 4.. 7  Fault on which domain */
            RESERVED(0 : 1, uint32_t)
            uint32_t LPAE : 1; /*!< \brief bit:     9  Large Physical Address
                                  Extension */
...
#define IFSR_STATUS_Msk \
    ...
    typedef union
    {
        struct
        {
            ...
            uint32_t
                A : 1; /*!< \brief bit:     8  External abort pending bit */
...
*/
    ...
    typedef struct
    {
        ...
        __IM uint32_t CACHE_TYPE; /*!< \brief Offset: 0x0004 (R/ ) Cache Type
                                     Register             */
        ...
        __IOM uint32_t EVENT_CONTROL; /*!< \brief Offset: 0x0200 (R/W) Event
                                         Counter Control           */
        __IOM uint32_t
            EVENT_COUNTER1_CONF; /*!< \brief Offset: 0x0204 (R/W) Event Counter
                                    1 Configuration   */
        __IOM uint32_t
            EVENT_COUNTER0_CONF; /*!< \brief Offset: 0x0208 (R/W) Event Counter
                                    1 Configuration   */
        ...
        __IM uint32_t MASKED_INT_STATUS; /*!< \brief Offset: 0x0218 (R/ ) Masked
                                            Interrupt Status         */
        __IM uint32_t RAW_INT_STATUS;    /*!< \brief Offset: 0x021c (R/ ) Raw
                                            Interrupt Status            */
        __OM uint32_t INTERRUPT_CLEAR;   /*!< \brief Offset: 0x0220 ( /W)
                                            Interrupt Clear                 */
        RESERVED(3 [0x143], uint32_t)
        __IOM uint32_t
            CACHE_SYNC; /*!< \brief Offset: 0x0730 (R/W) Cache Sync */
        RESERVED(4 [0xf], uint32_t)
        __IOM uint32_t INV_LINE_PA; /*!< \brief Offset: 0x0770 (R/W) Invalidate
                                       Line By PA           */
        RESERVED(6 [2], uint32_t)
        __IOM uint32_t
            INV_WAY; /*!< \brief Offset: 0x077c (R/W) Invalidate by Way */
        RESERVED(5 [0xc], uint32_t)
        __IOM uint32_t CLEAN_LINE_PA; /*!< \brief Offset: 0x07b0 (R/W) Clean
                                         Line by PA                */
        RESERVED(7 [1], uint32_t)
        __IOM uint32_t CLEAN_LINE_INDEX_WAY; /*!< \brief Offset: 0x07b8 (R/W)
                                                Clean Line by Index/Way */
        __IOM uint32_t
            CLEAN_WAY; /*!< \brief Offset: 0x07bc (R/W) Clean by Way */
        RESERVED(8 [0xc], uint32_t)
        __IOM uint32_t CLEAN_INV_LINE_PA; /*!< \brief Offset: 0x07f0 (R/W) Clean
                                             and Invalidate Line by PA  */
        ...
        __IOM uint32_t DATA_LOCK_0_WAY; /*!< \brief Offset: 0x0900 (R/W) Data
                                           Lockdown 0 by Way          */
        __IOM uint32_t INST_LOCK_0_WAY; /*!< \brief Offset: 0x0904 (R/W)
                                           Instruction Lockdown 0 by Way   */
        __IOM uint32_t DATA_LOCK_1_WAY; /*!< \brief Offset: 0x0908 (R/W) Data
                                           Lockdown 1 by Way          */
        __IOM uint32_t INST_LOCK_1_WAY; /*!< \brief Offset: 0x090c (R/W)
                                           Instruction Lockdown 1 by Way   */
        __IOM uint32_t DATA_LOCK_2_WAY; /*!< \brief Offset: 0x0910 (R/W) Data
                                           Lockdown 2 by Way          */
        __IOM uint32_t INST_LOCK_2_WAY; /*!< \brief Offset: 0x0914 (R/W)
                                           Instruction Lockdown 2 by Way   */
        __IOM uint32_t DATA_LOCK_3_WAY; /*!< \brief Offset: 0x0918 (R/W) Data
                                           Lockdown 3 by Way          */
        __IOM uint32_t INST_LOCK_3_WAY; /*!< \brief Offset: 0x091c (R/W)
                                           Instruction Lockdown 3 by Way   */
        __IOM uint32_t DATA_LOCK_4_WAY; /*!< \brief Offset: 0x0920 (R/W) Data
                                           Lockdown 4 by Way          */
        __IOM uint32_t INST_LOCK_4_WAY; /*!< \brief Offset: 0x0924 (R/W)
                                           Instruction Lockdown 4 by Way   */
        __IOM uint32_t DATA_LOCK_5_WAY; /*!< \brief Offset: 0x0928 (R/W) Data
                                           Lockdown 5 by Way          */
        __IOM uint32_t INST_LOCK_5_WAY; /*!< \brief Offset: 0x092c (R/W)
                                           Instruction Lockdown 5 by Way   */
        __IOM uint32_t DATA_LOCK_6_WAY; /*!< \brief Offset: 0x0930 (R/W) Data
                                           Lockdown 5 by Way          */
        __IOM uint32_t INST_LOCK_6_WAY; /*!< \brief Offset: 0x0934 (R/W)
                                           Instruction Lockdown 5 by Way   */
        __IOM uint32_t DATA_LOCK_7_WAY; /*!< \brief Offset: 0x0938 (R/W) Data
                                           Lockdown 6 by Way          */
        __IOM uint32_t INST_LOCK_7_WAY; /*!< \brief Offset: 0x093c (R/W)
                                           Instruction Lockdown 6 by Way   */
        RESERVED(11 [0x4], uint32_t)
        __IOM uint32_t LOCK_LINE_EN; /*!< \brief Offset: 0x0950 (R/W) Lockdown
                                        by Line Enable         */
        __IOM uint32_t UNLOCK_ALL_BY_WAY; /*!< \brief Offset: 0x0954 (R/W)
                                             Unlock All Lines by Way         */
        RESERVED(12 [0xaa], uint32_t)
        __IOM uint32_t ADDRESS_FILTER_START; /*!< \brief Offset: 0x0c00 (R/W)
                                                Address Filtering Start */
        __IOM uint32_t ADDRESS_FILTER_END;   /*!< \brief Offset: 0x0c04 (R/W)
                                                Address Filtering End           */
        RESERVED(13 [0xce], uint32_t)
        __IOM uint32_t DEBUG_CONTROL; /*!< \brief Offset: 0x0f40 (R/W) Debug
                                         Control Register          */
    } L2C_310_TypeDef;
...
#define L2C_310          \
    ...
    typedef struct
    {
        __IOM uint32_t CTLR; /*!< \brief  Offset: 0x000 (R/W) Distributor
                                Control Register */
        __IM uint32_t TYPER; /*!< \brief  Offset: 0x004 (R/ ) Interrupt
                                Controller Type Register */
        __IM uint32_t IIDR;  /*!< \brief  Offset: 0x008 (R/ ) Distributor
        ...
        RESERVED(3, uint32_t)
        __OM uint32_t SETSPI_SR; /*!< \brief  Offset: 0x050 ( /W) Set SPI,
                                    Secure Register */
        RESERVED(4, uint32_t)
        __OM uint32_t CLRSPI_SR; /*!< \brief  Offset: 0x058 ( /W) Clear SPI,
                                    Secure Register */
        RESERVED(5 [9], uint32_t)
        __IOM uint32_t IGROUPR[32];   /*!< \brief  Offset: 0x080 (R/W) Interrupt
                                         Group Registers */
        ...
        __IOM uint32_t IPRIORITYR[255]; /*!< \brief  Offset: 0x400 (R/W)
                                           Interrupt Priority Registers */
        RESERVED(6, uint32_t)
        __IOM uint32_t ITARGETSR[255]; /*!< \brief  Offset: 0x800 (R/W)
                                          Interrupt Targets Registers */
        RESERVED(7, uint32_t)
        __IOM uint32_t ICFGR[64];    /*!< \brief  Offset: 0xC00 (R/W) Interrupt
                                        Configuration Registers */
        __IOM uint32_t IGRPMODR[32]; /*!< \brief  Offset: 0xD00 (R/W) Interrupt
                                        Group Modifier Registers */
        RESERVED(8 [32], uint32_t)
        __IOM uint32_t NSACR[64]; /*!< \brief  Offset: 0xE00 (R/W) Non-secure
        ...
        __IOM uint32_t CPENDSGIR[4]; /*!< \brief  Offset: 0xF10 (R/W) SGI
                                        Clear-Pending Registers */
        __IOM uint32_t SPENDSGIR[4]; /*!< \brief  Offset: 0xF20 (R/W) SGI
                                        Set-Pending Registers */
...
#define GICDistributor                                                         \
    ...
    typedef struct
    {
        __IOM uint32_t CTLR; /*!< \brief  Offset: 0x000 (R/W) CPU Interface
                                Control Register */
        __IOM uint32_t PMR;  /*!< \brief  Offset: 0x004 (R/W) Interrupt Priority
                                Mask Register */
        __IOM uint32_t
            BPR; /*!< \brief  Offset: 0x008 (R/W) Binary Point Register */
        __IM uint32_t IAR; /*!< \brief  Offset: 0x00C (R/ ) Interrupt
                              Acknowledge Register */
        __OM uint32_t
            EOIR; /*!< \brief  Offset: 0x010 ( /W) End Of Interrupt Register */
        __IM uint32_t
            RPR; /*!< \brief  Offset: 0x014 (R/ ) Running Priority Register */
        __IM uint32_t HPPIR;  /*!< \brief  Offset: 0x018 (R/ ) Highest Priority
                                 Pending Interrupt Register */
        __IOM uint32_t ABPR;  /*!< \brief  Offset: 0x01C (R/W) Aliased Binary
                                 Point Register */
        __IM uint32_t AIAR;   /*!< \brief  Offset: 0x020 (R/ ) Aliased Interrupt
                                 Acknowledge Register */
        __OM uint32_t AEOIR;  /*!< \brief  Offset: 0x024 ( /W) Aliased End Of
                                 Interrupt Register */
        ...
        __IOM uint32_t NSAPR[4]; /*!< \brief  Offset: 0x0E0 (R/W) Non-secure
        ...
        __OM uint32_t DIR; /*!< \brief  Offset: 0x1000( /W) Deactivate Interrupt
                              Register */
    } GICInterface_Type;

#define GICInterface                                                       \
    ((GICInterface_Type *)                                                 \
         GIC_INTERFACE_BASE) /*!< \brief GIC Interface register set access \
                                pointer */
#endif
    ...
    typedef struct
    {
        ...
        __IOM uint32_t COUNTER;  //!< \brief  Offset: 0x004 (R/W) Private Timer
                                 //!< Counter Register
        __IOM uint32_t CONTROL;  //!< \brief  Offset: 0x008 (R/W) Private Timer
                                 //!< Control Register
        __IOM uint32_t ISR;      //!< \brief  Offset: 0x00C (R/W) Private Timer
                                 //!< Interrupt Status Register
        RESERVED(0 [4], uint32_t)
        __IOM uint32_t
            WLOAD;  //!< \brief  Offset: 0x020 (R/W) Watchdog Load Register
        __IOM uint32_t WCOUNTER;  //!< \brief  Offset: 0x024 (R/W) Watchdog
                                  //!< Counter Register
        __IOM uint32_t WCONTROL;  //!< \brief  Offset: 0x028 (R/W) Watchdog
                                  //!< Control Register
        __IOM uint32_t WISR;      //!< \brief  Offset: 0x02C (R/W) Watchdog
                                  //!< Interrupt Status Register
        __IOM uint32_t WRESET;   //!< \brief  Offset: 0x030 (R/W) Watchdog Reset
                                 //!< Status Register
        __OM uint32_t WDISABLE;  //!< \brief  Offset: 0x034 ( /W) Watchdog
                                 //!< Disable Register
    } Timer_Type;
#define PTIM ((Timer_Type *)TIMER_BASE) /*!< \brief Timer register struct */
    ...
    __STATIC_FORCEINLINE void L1C_CleanDCacheMVA(void *va)
    {
        ...
        __DMB();  // ensure the ordering of data cache maintenance operations
                  // and their effects
    }
     ...
     * \param [in] maint 0 - invalidate, 1 - clean, otherwise - invalidate and
     * clean
     */
     ...
     * Generic mechanism for cleaning/invalidating the entire data or unified
     * cache to the point of coherency \param [in] op 0 - invalidate, 1 - clean,
     * otherwise - invalidate and clean
     */
     ...
     * Generic mechanism for cleaning/invalidating the entire data or unified
     * cache to the point of coherency \param [in] op 0 - invalidate, 1 - clean,
     * otherwise - invalidate and clean \deprecated Use generic
     * L1C_CleanInvalidateCache instead.
     */
    CMSIS_DEPRECATED
 ...
 * ###################################### */
    ...
    {
        return (GICDistributor->ITARGETSR[IRQn / 4U] >> ((IRQn % 4U) * 8U)) &
               0xFFUL;
    }
    ...
    __STATIC_INLINE uint32_t GIC_GetPendingIRQ(IRQn_Type IRQn)
    {
        ...
        else
        {
            ...
            pend =
                (GICDistributor->SPENDSGIR[IRQn / 4U] >> ((IRQn % 4U) * 8U)) &
                0xFFUL;
     ...
     * model, 1 - 1-N model for some GIC before v1) Bit 1: 0 - level sensitive,
     * 1 - edge triggered
     */
     ...
     * \param [in] IRQn Interrupt to acquire the configuration for.
     * \return Int_config field value. Bit 0: Reserved (0 - N-N model, 1 - 1-N
     * model for some GIC before v1) Bit 1: 0 - level sensitive, 1 - edge
     * triggered
     */
    ...
    /** \brief Read the current interrupt priority from GIC's IPRIORITYR
     * register. \param [in] IRQn The interrupt to be queried.
     */
    ...
    /** \brief Configures the group priority and subpriority split point using
     * CPU's BPR register. \param [in] binary_point Amount of bits used as
     * subpriority.
     */
    ...
    __STATIC_INLINE uint32_t GIC_GetIRQStatus(IRQn_Type IRQn)
    {
        ...
        active =
            ((GICDistributor->ISACTIVER[IRQn / 32U]) >> (IRQn % 32U)) & 1UL;
                                     ...
                                     uint32_t filter_list)
    {
        GICDistributor->SGIR = ((filter_list & 3U) << 24U) |
                               ((target_list & 0xFFUL) << 16U) |
                               (IRQn & 0x0FUL);
    }

    /** \brief Get the interrupt number of the highest interrupt pending from
     * CPU's HPPIR register. \return GICInterface_Type::HPPIR
     */
    ...
    /** \brief Provides information about the implementer and revision of the
     * CPU interface. \return GICInterface_Type::IIDR
     */
...
/* PL1 Physical Timer */
    ...
    typedef union
    {
        struct
        {
            ...
            uint32_t IMASK : 1; /*!< \brief bit: 1      Timer output signal mask
                                   bit. */
            uint32_t
                ISTATUS : 1; /*!< \brief bit: 2      The status of the timer. */
...
/* Private Timer */
    ...
    /** ref Timer_Type::CONTROL Get the current timer configuration from its
     * CONTROL register. \return Timer_Type::CONTROL
     */
...
#define page64k_device_rw(descriptor_l1, descriptor_l2, region) \
    ...
    */
    ...
    /** \brief  Set section Security attribute
      ...
      \param [out]    descriptor_l1  L1 descriptor.
      \param [in]             s_bit  Section Security attribute: SECURE,
      NON_SECURE
    ...
    */
    ...
    /** \brief  Set 4k/64k page shareability
      ...
      \param [out]    descriptor_l2  L2 descriptor.
      \param [in]             s_bit  4k/64k page shareability: NON_SHARED,
      SHARED
    ...
    */
        ...
        *descriptor_l1 &= SECTION_TEXCB_MASK;
        ...
        else if (NORMAL == mem)
        {
            *descriptor_l1 |= 1 << SECTION_TEX2_SHIFT;
            ...
            case WB_NO_WA:
                *descriptor_l1 |=
                    (1 << SECTION_B_SHIFT) | (1 << SECTION_C_SHIFT);
                break;
            }
            switch (outer)
            {
            ...
            case WB_NO_WA:
                *descriptor_l1 |=
                    (1 << SECTION_TEX0_SHIFT) | (1 << SECTION_TEX0_SHIFT);
                break;
            }
        }
        return 0;
    ...
    /** \brief  Set 4k/64k page memory attributes
      ...
      SHARED_DEVICE, NON_SHARED_DEVICE, STRONGLY_ORDERED \param [in] outer Outer
      cacheability: NON_CACHEABLE, WB_WA, WT, WB_NO_WA, \param [in] inner  Inner
      cacheability: NON_CACHEABLE, WB_WA, WT, WB_NO_WA, \param [in] page  Page
      size
        ...
        else
        {
            ...
            else if (NORMAL == mem)
            {
                *descriptor_l2 |= 1 << PAGE_4K_TEX2_SHIFT;
                ...
                case WB_NO_WA:
                    *descriptor_l2 |=
                        (1 << PAGE_4K_B_SHIFT) | (1 << PAGE_4K_C_SHIFT);
                    break;
                }
                switch (outer)
                {
    ...
    */
                                                 ...
                                                 mmu_region_attributes_Type reg)
    {
        *descriptor = 0;
        ...
        MMU_MemorySection(
            descriptor, reg.mem_t, reg.outer_norm_t, reg.inner_norm_t);
    ...
    */
    ...
    __STATIC_INLINE void MMU_Enable(void)
    {
        ...
        // Clear TRE bit to disable TEX remap and A bit to disable strict
